    ...
    render: function () {
        return (<div>
            ...
            {!this.props.playlist.data? (<div>
                <p>Please enter the spotify ID of the currently playing playlist. The spotify API does not allow to retrieve this information. Go into your Spotify client, right click the playlist and select &quot;Copy Spotify URI&quot;.</p>
            </div>) : (<div>
                <div className="row">
                    ...
                    <div className="col-xs-4">
                        <img src={this.props.playlist.data.images[0].url} className="img-responsive img-thumbnail pull-right" />
                    </div>
                </div>
            </div>)}
        </div>)
